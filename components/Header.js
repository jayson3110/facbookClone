...
import {BellIcon,ChatIcon,ChevranDownIcon,HomeIcon,UserGroupIcon,ViewGridIcon}  from '@heroicons/react/solid'
import {FlagIcon, PlayIcon, SearchIcon, ShoppingCartIcon} from  '@heroicons/react/outline'
import HeaderIcon from "./HeaderIcon";

export default function Header() {
	return (
		<div className="sticky top-0 z-58 bg-white flex items-center p-2 lg:px-5 shadow-md">
		   {/* Left  */}
